...
<head>
    <meta charset="UTF-8">
    <meta name="author" content="Ahmed Reda">
    <meta name="description" content="Assistant">
    <meta name="keywords" content="Assistant,Mr Hany">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="type" content="Educational Organization">
    ...
    <link href="https://fonts.googleapis.com/css?family=Rubik:400,700&display=swap" rel="stylesheet">
        ...
        <!-- Scripts -->
        <script src="{{ asset('bootstrap/app.js') }}" defer></script>
